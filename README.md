...
Here, `model-native` means the bucket map is generated by and versioned for a specific target model. It does not claim hidden access to model-internal cognition, consciousness, or an objectively correct semantic structure.
